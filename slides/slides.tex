...
\begin{frame}{Number and Pay of Federal Economists}
  \begin{center}
    \includegraphics[width=0.90\textwidth]{fed_economists_2025}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}\small
...
\begin{frame}{Hires and Departures: the Clearer Signal}
  \begin{center}
    \includegraphics[width=0.86\textwidth]{econ_flows_2025}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}\small
...
\begin{frame}{Why They Left: RIF and Buyout, Not Ordinary Turnover}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{econ_separation_reasons_2025}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}\small
...
\begin{frame}{Where Economists Were Gained and Lost}
  \begin{center}
    \includegraphics[width=0.72\textwidth]{econ_agency_change_2025}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}\small
...
\begin{frame}{Historical Context: Economists Since 1998}
  \begin{center}
    \includegraphics[width=0.86\textwidth]{econ_headcount_since_1998}
  \end{center}
  \vspace{-0.3em}
  \begin{itemize}\small
...
\begin{frame}{Historical Context: 2025 Outflow vs.\ Prior Years}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \includegraphics[width=\textwidth]{econ_separations_history}
    \end{column}
    \begin{column}{0.46\textwidth}
      \includegraphics[width=\textwidth]{econ_q1_history}
    \end{column}
  \end{columns}
  \vspace{-0.2em}
  \begin{itemize}\small
    \item FY2024 was the calmest year on record (277 separations). FY2025's
          \textbf{first six months} already hit 215.
    \item Jan--Mar 2025: most departures and nearly fewest hires of any Q1 since
          2015. Prior worst Q1 was 2017 (first Trump transition).
    \item The one precedent for elevated attrition --- FY2019, the ERS move to
          Kansas City --- was one agency; 2025 is government-wide.
    \item \textbf{No separation carries a formal RIF code}, FY2015 through Mar
          2025 --- it is running through quits, retirements and term-appointment
          endings.
  \end{itemize}
\end{frame}
